...
> <g id="1">Who was the initial champion for the OSPO? </g>
...
> <g id="1">F5 の場合、OSPO を作成する主なきっかけは、2019 年にオープン ソース企業である Nginx を買収したことでした。この買収は、Nginx チームが F5 に参加し、別の声を後押しする存在になったことを意味します。これにより、オープンソースの戦略的重要性も高まりました。 </g>
